function readPoints(src,evn,allGraphics,ss_STEP)
...
quest = '\fontsize{16} Provide XYZ txt file or use Cartesian/cylindrical grids';
answer = questdlg(quest,'Importing points',...
    'XYZ txt','Cartesian','Cylindrical',opts) ;
%----------
