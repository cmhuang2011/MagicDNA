function  LegendBoxing_customSQ( src,evn,axMain )
...
% axMain.UserData
       ...
       if evn.IntersectionPoint(2)>0
           ...
           STR={'\fontsize{11}Custom square(SQ) lattice cross-sections: ';
                'This UI provides five different customized cross-sections for SQ cross-sections.';
