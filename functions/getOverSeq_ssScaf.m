function [OneOverHang,stapletext0]=getOverSeq_ssScaf( overhang_length,OtherOverhangs,ssScaf,EntireScaf)
...
% clc
% tic
overhang_lengthO=overhang_length ;
...
% if overhang_lengthO>10 
%    overhang_length=overhang_length-3;
% else
%    overhang_length=overhang_length-2;
% end
% overhang_length
...
len = 5 ;%the length of starting sequences %------------------
all = bases;
for i=1:len-1
    temp = all.*bases';
