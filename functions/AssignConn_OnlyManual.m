function choice = AssignConn_OnlyManual(B1,hyperB,AssFigH,patchH,lineIndex)
...
txt = uicontrol('Parent',d,'Style','text','Position',[180 130 250 40],...
...
popup1 = uicontrol('Parent',hp1,...
    ...
    'String',{'Manual';'Side only';'End only'},...
    'Callback',@popup_callback1,'Enable','off');
%            popup_callback1
...
popup2 = uicontrol('Parent',hp1,...
    ...
    'String',{'Manual';'Side only';'End only'},...
    'Callback',@popup_callback2,'Enable','off');

btn = uicontrol('Parent',d,...
    'Units','normalized','Position',[0.45 0.2 0.1 0.1],...
    'String','OK','FontSize',12,...
    'Callback',{@(src,evn)Exportresult(src,evn,ed)},'Enable','off');
