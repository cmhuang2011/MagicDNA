function varargout=plotScaf2_Helix_V2_noGraphics( GetHyperB,CornerNotation,Isstap ,color , TM )
...
%output in no graphical version---------
% varargout{1} = pScaf2H ;   % graphic object
varargout{1} = StapHelix2Cell ;  % 3D helix XYZ 
% varargout{3} = pScaf_center ;  % graphic object scatter
varargout{2} = BasecCenterCell ;  % 3D helix XYZ of oxdna center
