...
%        evn
       ...
       if evn.IntersectionPoint(2)>0.5
           ...
           STR={'\fontsize{11}Use the keyboard and the mouse to interact.'  ;'';
               '\fontsize{11}Bundle manipulation :';'Either use the listbox to select bundles or directly click the 3D bundles.'; 'Multiple selection is possible with ''ctrl'' or middle click. ' 
               ...
               'Helpful tools:' ;'[U]: \bfU\rmndo the previous bundle manipulation'; '[L]: esitmate scaffold \bfL\rmength, show in command line';'[C]: print the \bfC\rmylinder model as .bild to Chimera';
