classdef MagicDNA_v15App < handle
    %
    % Usage:
    %     app.MagicDNA_v15App
    ...
    properties (Constant)
        AppPathBase = {'/MagicDNA_v15/code'};
        AppClass = 'MagicDNA_v15App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            MagicDNA_v15App.refcount(obj.Increment);
